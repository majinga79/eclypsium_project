...
function child_feature2_13() {
        echo
        echo "This is function child feature 2 - 13"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_14() {
        echo
        echo "This is function child feature 2 - 14"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_15() {
        echo
        echo "This is function child feature 2 - 15"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_16() {
        echo
        echo "This is function child feature 2 - 16"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_17() {
        echo
        echo "This is function child feature 2 - 17"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_18() {
        echo
        echo "This is function child feature 2 - 18"
        echo
        read -p "Press enter to terminate session: " enter

}

function child_feature2_19() {
        echo
        echo "This is function child feature 2 - 19"
        echo
        read -p "Press enter to terminate session: " enter
...
function child_feature2_21() {
        echo
        echo "This is function child feature 2 - 21"
        echo
        read -p "Press enter to terminate session: " enter
...
function child_program2() {
  ...
  while true; do
    ...
    echo "13 - Child feature 2 - 13"
    echo "14 - Child feature 2 - 14"
    echo "15 - Child feature 2 - 15"
    echo "16 - Child feature 2 - 16"
    echo "17 - Child feature 2 - 17"
    echo "18 - Child feature 2 - 18"
    echo "19 - Child feature 2 - 19"
    echo "20 - Child feature 2 - 20"
    echo "21 - Child feature 2 - 21"
    echo "22 - Main program"
    echo
    read -p "Select feature and press enter: " choice
    case $choice in
